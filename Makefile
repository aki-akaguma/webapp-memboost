...
bundle-web:
	dx bundle --web --release --base-path "/memboost"
...
bundle-android-aarch64:
	...
	./scripts/apk-icon-assemble-r.sh memboost aarch64 resources/android

bundle-android-x86_64:
	@rm -fr "target/dx"
	dx bundle --android --release --target=x86_64-linux-android
	./scripts/apk-icon-assemble-r.sh memboost x86_64 resources/android

bundle-android-wva:
	@rm -fr "target/dx"
	./scripts/wva-apk-icon-assemble-r.sh memboost resources/android ./scripts/android-webview-assets-params.toml
